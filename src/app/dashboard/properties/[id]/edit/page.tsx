...
export default function EditPropertyPage({
  ...
  const [clientName, setClientName] = useState(property?.clientName ?? "");
  ...
  function updateRoomDraft(roomId: string, value: string) {
    setRooms((prev) =>
      prev.map((r) => (r.id === roomId ? { ...r, draftItem: value } : r))
    );
  }
    ...
    <>
      ...
      <div className="flex-1 px-4 lg:px-8 py-6 lg:py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-[#0F172A]">Edit property</h2>
            <p className="text-sm text-[#64748B] mt-1">
              Update details and checklist for {property.clientName}.
            </p>
          </div>
